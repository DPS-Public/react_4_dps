...
import { renderDiffLines } from '@/ui-canvas/uic_backlog_canvas_add_github_commits_as_issue/utils/utilRenderDiffLines';
 ...
 * Renders the unified diff for that file with +/- stats in the header.
 */
const FileChangesModal: React.FC<FileChangesModalProps> = ({ visible, file, code, loading, onClose }) => (
    <Modal
        title={
            <div>
        ...
        {loading ? (
            ...
            <div style={{ maxHeight: '70vh', overflow: 'auto' }}>
                <pre style={{
                    ...
                    fontSize: 12, lineHeight: 1.6, fontFamily: 'monospace', margin: 0, color: '#d4d4d4',
                }}>
