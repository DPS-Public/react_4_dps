...
export default React.memo(UICanvasUpdateInputDrawer, (prevProps, nextProps) => prevProps.open === nextProps.open);

function UICanvasUpdateInputDrawer({
                                                      open,
                                                      onClose,
                                                      updateInput,
                                                      selectedInput
    ...
    useEffect(() => {
        if (open && selectedInput) {
            setName(selectedInput.inputName)
            setError(null);
        }
    }, [open]);
